...
import MushroomImage from "../assets/mushrooms.jpg";

const About = () => {
  return (
    <>
      <Helmet>
        <title>Swad Mushrooms | About</title>
      </Helmet>
      <div className="max-w-6xl mx-auto px-4 py-12 sm:py-16 md:py-20">
        ...
        <p className="text-base sm:text-lg md:text-xl leading-relaxed text-gray-800 mb-6">
          ...
          we believe that good food begins with natural, healthy ingredients.
          Our journey started with a simple mission — to provide{" "}
        ...
        <p className="text-base sm:text-lg md:text-xl leading-relaxed text-gray-800 mb-6">
          ...
          techniques, our mushrooms are grown in controlled conditions that
          ensure the right texture, taste, and nutrition.
        </p>
        ...
        <div className="mt-12 bg-green-50 p-4 sm:p-6 md:p-8 rounded-xl shadow-md">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed">
            We promise to provide fresh, natural, and healthy mushrooms that
            bring joy to your meals. With Swad Mushrooms, you don’t just eat —{" "}
            <span className="font-semibold">
              you eat fresh, you eat healthy
            </span>
            .
          </p>
        </div>
